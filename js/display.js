...
logoLeft.style = "max-width:200px;max-height:200px;";
...
wordart.style = "max-width:1000px;max-height:200px;";
header.appendChild(homeLink);
...
logoRight.style = "max-width:200px;max-height:200px;";
header.appendChild(homeLink);
...
gif1.alt = "Web Button"
gif1.style = "max-width:88px;max-height:31px;";
footer.append(gif1);

const gif2 = document.createElement('img');
gif2.src = "./Images/Buttons/anybrowser2.gif";
gif2.alt = "Web Button"
gif2.style = "max-width:88px;max-height:31px;";
footer.append(gif2);
...
gif3.alt = "Web Button"
gif3.style = "max-width:88px;max-height:31px;";
footer.append(gif3);

const gif4 = document.createElement('img');
gif4.src = "./Images/Buttons/got_html.gif";
gif4.alt = "Web Button"
gif4.style = "max-width:88px;max-height:31px;";
footer.append(gif4);
